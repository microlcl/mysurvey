		...
		<div class="control-group">
				...
				<div class="controls">
					<label class="radio inline">
						<input id="type1" type="radio" name="questionType" value="1">单选
					</label>
					<label class="radio inline">
						<input id="type2" type="radio" name="questionType" value="2" >多选
					</label>
					<label class="radio inline">
						<input id="type3" type="radio" name="questionType" value="3" >开放性问题
					</label>
				</div>
		</div>	
		<div class="control-group">
