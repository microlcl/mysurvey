...
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(1,'R',null,'admin',1,'ibm.com','Testing1','2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(2,'P',null,'admin',1,'ibm.com','Testing2','1,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(3,'F',null,'admin',1,'ibm.com','Testing3','1,2',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(4,'N',null,'admin',1,'ibm.com','Testing3','1',null,null,'T','just for testing');
...
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(7,'F',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(8,'F',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(9,'F',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_timestamp, is_anonymous, description) values(10,'F',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
