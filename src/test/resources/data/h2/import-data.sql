...
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_tiemstamp, is_anonymous, description) values(4,'N',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_tiemstamp, is_anonymous, description) values(5,'D',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
insert into survey(survey_id, status, update_timestamp, user_id, paper_id, paper_url, subject, groups_id, sent_timestamp, deadline_tiemstamp, is_anonymous, description) values(6,'C',null,'admin',1,'ibm.com','Testing3','1,2,3',null,null,'T','just for testing');
